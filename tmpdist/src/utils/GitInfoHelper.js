...
export class GitInfoHelper {
     ...
     */
    async getGitRepositoryInfo(executeCommand) {
        try {
            ...
            const [currentBranchCmd, statusCmd, headCmd, recentCommitsCmd, modifiedFilesCmd, stagedFilesCmd, untrackedFilesCmd, deletedFilesCmd] = await Promise.all([
                // Basic repo info
...
//# sourceMappingURL=GitInfoHelper.js.map