 ...
 */
export async function rollbackSession(sessionId, sessionState, repoRoot, messageId) {
    ...
    sessionState.skipAbortAck = true;
    ...
    // --------------------------------------------------------------------
    let restoredSha = undefined;
    if (checkpointId) {
        restoredSha = await CheckpointManager.restore(sessionId, sessionState.executionAdapter, repoRoot, checkpointId);
    }
    // --------------------------------------------------------------------
