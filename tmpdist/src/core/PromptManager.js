 ...
 * @internal
 */
export class BasicPromptManager {
    /**
     ...
     */
    constructor(basePrompt = DEFAULT_SYSTEM_PROMPT, defaultTemperature = 0.2) {
...
DO NOT suggest using more tools - you have reached your limit for this interaction.`;
    ...
    setDirectoryStructurePrompt(directoryStructure) {
 ...
 * @internal
 */
export function createDefaultPromptManager(temperature) {
 ...
 * @internal
 */
export function createPromptManager(basePrompt, temperature) {
